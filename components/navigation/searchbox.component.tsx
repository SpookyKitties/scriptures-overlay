...
const bookNames = [
  ...
  ["ezra"],
    ...
    ["moses"],
    ["abraham", "abr.", "abr"],
    ["joseph smith—matthew", "joseph smith–matthew", "joseph smith-matthew", "joseph smith matthew", "js—m", "js–m", "jsm", "js-m"],
    ["joseph smith—history", "js-h", "joseph smith–history", "joseph smith-history", "joseph smith history", "js–h", "js—h", "jsh", "js-h"],
